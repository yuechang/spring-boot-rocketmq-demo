        ...
        try {
            ...
            for (int i = 0; i < 100; i++) {
                ...
                Message msg = new Message("PushTopic", "push",
                        "key_" + "i", message.getBytes());

                SendResult result = producer.send(msg);

                System.out.println("发送响应：MsgId：" + result.getMsgId() +
                                   ",发送状态：SendStatus：" + result.getSendStatus());
